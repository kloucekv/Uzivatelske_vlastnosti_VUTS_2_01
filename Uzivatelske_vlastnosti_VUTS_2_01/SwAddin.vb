...
#Region "Local Variables"
    ...
    Dim myTaskpaneHost As TP_vlastnosti
...
#Region "UI Methods"
    ...
    Public Sub AddCommandMgr()
        ...
        cmdGroup.LargeIconList = iBmp.CreateFileFromResourceBitmap("SwVBAddin5.ToolbarLarge.bmp", thisAssembly)
        cmdGroup.SmallIconList = iBmp.CreateFileFromResourceBitmap("SwVBAddin5.ToolbarSmall.bmp", thisAssembly)
        cmdGroup.LargeMainIcon = iBmp.CreateFileFromResourceBitmap("SwVBAddin5.MainIconLarge.bmp", thisAssembly)
        cmdGroup.SmallMainIcon = iBmp.CreateFileFromResourceBitmap("SwVBAddin5.MainIconSmall.bmp", thisAssembly)
